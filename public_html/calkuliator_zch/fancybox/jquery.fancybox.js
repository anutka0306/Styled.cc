...
(function (window, document, $, undefined) {
	...
	var W = $(window),
		...
		isScrollable = function(el) {
			return (el && !(el.style.overflow === 'none' && el.style.overflow === 'hidden') && ((el.clientWidth && el.scrollWidth > el.clientWidth) || (el.clientHeight && el.scrollHeight > el.clientHeight)));
		},
